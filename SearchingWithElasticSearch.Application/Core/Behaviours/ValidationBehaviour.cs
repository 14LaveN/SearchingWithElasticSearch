...
using MediatR;
using ValidationException = SearchingWithElasticSearch.Application.Core.Exceptions.ValidationException;

namespace SearchingWithElasticSearch.Application.Core.Behaviours;
