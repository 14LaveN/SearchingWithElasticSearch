...
using Prometheus;
using SearchingWithElasticSearch.Cache.Service;

namespace SearchingWithElasticSearch.Application.Core.Helpers.Metric;
...
public sealed class CreateMetricsHelper
{
    private static readonly Counter RequestCounter =
        Metrics.CreateCounter("SearchingWithElasticSearch_requests_total", "Total number of requests.");
    ...
    public async Task CreateMetrics(Stopwatch stopwatch)
    {
        ...
        Metrics.CreateHistogram("SearchingWithElasticSearch_request_duration_seconds", "Request duration in seconds.")
